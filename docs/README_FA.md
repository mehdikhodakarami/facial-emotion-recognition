...
تشخیص می‌دهد و از وب‌کم به‌صورت زنده کار می‌کند. به‌عنوان پروژهٔ پایانی هوش مصنوعی و با تمرکز بر
**انجام درستِ کار** ساخته شده: خط‌لولهٔ دادهٔ کم‌حافظه، معماری مدرنِ مبتنی بر توجه، تفکیک منضبطِ
...
<p align="center"><i>ساخته‌شده با ❤️ به‌عنوان پروژهٔ پایانی هوش مصنوعی.</i></p>
